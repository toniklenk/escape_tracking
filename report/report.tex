...
\begin{figure}
	...
	\caption{Angular velocity trajectories for mouse 6. Red vertical line indicated stimulus onset. Pronounced deflections after simulus onset indicate rapid reorientation - possibly towards shelter -, a hallmark of escape behaviour in mice. Trials selected as valid escape attempts are marked with a bold black border around the tile.}
	\label{fig:angularvelocity}
\end{figure}



Figure \ref{fig:angularvelocity} shows all trials of mouse 6 and the trajectories of head angular velocity. Notable deflections in angular velocity indicate rapid head movement in the plane paralled to the floor, corresponding to a change of head direction are present in trials 0, 3, 4, 6, 7, 13.

\subsection{Establishing a baseline for reorientation accuracy}
\begin{figure}
	\centering
