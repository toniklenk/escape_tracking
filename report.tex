...
Pose tracking of left ear, right ear and nose was performed using the software package DeepLabCut (DLC) \cite[]{Nath2019} for Python to train a CNN for pose estimation. Code with detailed descriptions can be found in \autoref{A}.\\
